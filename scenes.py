...
class cars():
	def McLaren():
		info_or_race = input(f"Would you like to race or receive info on your {result}? (Options: Info or Race)\n> ")
...
Predecessor:	McLaren 650S\n""")
			...
			pass
	def Camaro():
		info_or_race = input(f"Would you like to race or receive info on your {result}?\n> ")
		if info_or_race == "Info" or info_or_race == "info":
#info is pulled from wikipedia page
			print("""
...
def Annapolis():
	print("\nNow that you've completed Daytona, you can be included in a street race through Annapolis. The starting line is at the bottom of Main Street.")
	...
	def startLine():		
		...
		if c1 == "forward":
			...
			def elseif():
				print("To everyone's surprise, you turn and go the wrong way up Green Street! This shortcut allows you to end up right outside of St. Mary's. Make your final choice:")
				c1 = input("> ")
				if c1 == "forward":
					print("You've won the race, thanks to your knowledge of Annapolis and your choice of the shortcut! Congratulations.")
				elif c1 == "left":
					death("You obviously do not know where you're going, and you end up crashing into the yacht club and setting it on fire again.")
				elif c1 == "right":
					death("You end up crashing into oncoming traffic because of your incompetence.")
				else:
					print("Input not recognized, try again.")
					elseif()
...
def	LosAngeles():
	...
	print("Left\n" * 20)
	print(f"You win! Nice Job! You receive the Piston Cup, and the game ends. Well done, {name}.")
	exit(0)